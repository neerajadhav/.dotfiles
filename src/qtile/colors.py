...
PyWal = []
cache = "/home/neeraj/.cache/wal/colors"


def load_colors(cache):
    with open(cache, "r") as file:
        for i in range(8):
            PyWal.append(file.readline().strip())
    PyWal.append("#ffffff")
    lazy.reload()
...
Happy = [
    ["#000000", "#1c1f24"],  # bg
    ["#75C2F6", "#75C2F6"],  # fg
    ["#CAEDFF", "#CAEDFF"],  # color01
    ["#FEFFAC", "#FEFFAC"],  # color02
    ["#FBF0B2", "#FBF0B2"],  # color03
    ["#FFB6D9", "#FFB6D9"],  # color04
    ["#FFC7EA", "#FFC7EA"],  # color05
    ["#D67BFF", "#D67BFF"],  # color06
    ["#D8B4F8", "#D8B4F8"],  # color15
]

Cool = [
    ["#000000", "#1c1f24"],  # bg
    ["#4FC3F7", "#4FC3F7"],  # fg
    ["#4DD0E1", "#4DD0E1"],  # color01
    ["#4DB6AC", "#4DB6AC"],  # color02
    ["#81C784", "#81C784"],  # color03
    ["#AED581", "#AED581"],  # color04
    ["#DCE775", "#DCE775"],  # color05
    ["#FFF176", "#FFF176"],  # color06
    ["#FFD54F", "#FFD54F"],  # color15
]

Vintage = [
    ["#000000", "#1c1f24"],  # bg
    ["#FF8A65", "#FF8A65"],  # fg
    ["#FFAB91", "#FFAB91"],  # color01
    ["#7B1FA2", "#7B1FA2"],  # color02
    ["#512DA8", "#512DA8"],  # color03
    ["#303F9F", "#303F9F"],  # color04
    ["#1976D2", "#1976D2"],  # color05
    ["#0288D1", "#0288D1"],  # color06
    ["#0097A7", "#0097A7"],  # color15
]
